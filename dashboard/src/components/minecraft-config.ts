...
export const MINECRAFT_FIELDS: MinecraftField[] = [
  ...
  },
  {
    ...
    modpackCompatible: false,
    options: [
      { value: "LATEST", label: "Latest", description: "Always the newest stable release" },
      ...
      { value: "1.20.1", label: "1.20.1", description: "Popular modding version" },
      { value: "1.19.4", label: "1.19.4" },
      { value: "1.18.2", label: "1.18.2" },
      { value: "1.16.5", label: "1.16.5", description: "Legacy modding version" },
      { value: "1.12.2", label: "1.12.2", description: "Classic modding version" },
    ],
  },
  {
    key: "MEMORY",

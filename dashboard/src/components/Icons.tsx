...
export function GamepadIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      ...
      <circle cx="15" cy="10" r=".5" fill="currentColor" stroke="none" />
      <circle cx="17" cy="12" r=".5" fill="currentColor" stroke="none" />
      <path d="M2 12c0-4.418 0-6.627 1.172-7.828C4.343 3 6.229 3 10 3h4c3.771 0 5.657 0 6.828 1.172C22 5.373 22 7.582 22 12c0 4.418 0 6.627-1.172 7.828C19.657 21 17.771 21 14 21h-4c-3.771 0-5.657 0-6.828-1.172C2 18.627 2 16.418 2 12z" />
    </svg>
  );
}
...
export function LogsIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function EyeOffIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M10.6 6.2A9.9 9.9 0 0 1 12 6c6.4 0 10 7 10 7a17.6 17.6 0 0 1-2.7 3.6M6.6 6.9A17.4 17.4 0 0 0 2 13s3.6 7 10 7a9.7 9.7 0 0 0 5.1-1.4" />
...
/* Trazo 1.5 en rejilla de 24 para todos, sin excepción: un icono más grueso
   que sus vecinos es el tipo de detalle que delata una plantilla cosida. */

export function ServersIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BotIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 8V4.5M9.5 14h.01M14.5 14h.01M2 13v3M22 13v3" />
...
export function KeyIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="m10.5 12.5 8-8M16 7l2.5 2.5M19 4l2 2" />
    </svg>
  );
}
...
export function UsersIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M3 20a6 6 0 0 1 12 0M16.5 5.2a3.2 3.2 0 0 1 0 5.9M18 14.4A5.6 5.6 0 0 1 21 20" />
    </svg>
  );
}
...
export function AutoThemeIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function LogoutIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M14 4h4a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-4M10 16l-4-4 4-4M6 12h12" />
    </svg>
  );
}
